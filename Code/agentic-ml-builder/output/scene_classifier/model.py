...
class ResNet(nn.Module):
    def __init__(self, block: Type[BasicBlock], layers: List[int], num_classes: int = 1000) -> None:
        """Initialize the ResNet model.

        Args:
            block (Type[BasicBlock]): Block type to use in the model.
    ...
    def _make_layer(self, block: Type[BasicBlock], planes: int, blocks: int, stride: int = 1) -> nn.Sequential:
        ...
        Args:
            block (Type[BasicBlock]): Block type to use in the layer.
